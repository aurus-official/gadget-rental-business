...
public class EmailSenderService {
    ...
    public void sendVerificationCode(String receiverAddress, String code) throws MessagingException {
                            ...
                            <div>
                                ...
                                <div style="height: 80%% ; width: 100%%; display: flex; align-items: center; flex-direction: column;">
                                    <h6 style="padding-top: 0.5em;font-weight:normal; font-size: 0.8rem">
                                        Please verify your account with the 6-digit code below. <br />
